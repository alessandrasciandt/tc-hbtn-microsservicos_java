...
public class Product {
    ...
    public String toString() {
        return "Product{" + "id= " + id + ", code= " + code + ", name = " + name + ", descriptons = " + description +
                ", price= " + price + ", createdOne= " + createdOne + ", status = " + status + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(id, product.id) && Objects.equals(code, product.code) && Objects.equals(name, product.name)
                && Objects.equals(description, product.description) && Objects.equals(price, product.price) && Objects.equals(createdOne, product.createdOne)
